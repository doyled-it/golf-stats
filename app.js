...
// ===== DASHBOARD SECTION =====
function populateDashboardSection() {
    if (!data)
        return;
...
// ===== SCORING SECTION =====
function populateScoringSection() {
    if (!data)
        return;
...
// ===== SHOT ANALYTICS =====
function populateShotAnalytics() {
    if (!data)
        return;
...
// ===== COURSE PERFORMANCE =====
function populateCourseSection() {
    if (!data)
        return;
