 ...
 */
export function populateGoalsBurndown(goalsData) {
    ...
    // Scales
    const xScale = (index) => padding.left + (index / (burndownData.length - 1)) * chartWidth;
    const yScale = (handicap) => padding.top + chartHeight - ((handicap - minHandicap) / (maxHandicap - minHandicap)) * chartHeight;
 ...
 */
export function populateGoalsProgress(goalsData) {
