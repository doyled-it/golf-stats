 ...
 */
export function populateCoursePerformance(coursePerformance) {
...
function createCourseCard(course) {
    ...
    const sortedRounds = [...course.roundsList].sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime());
    ...
    const roundsList = card.querySelector('.course-rounds-list');
 ...
 */
function createHoleDifficultyVisualization(difficulties) {
