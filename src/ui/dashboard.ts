...
import type { GolfData, ScoringDistribution, Round } from '../types.js';
import { formatDate, formatScoreToPar, getScoreClass } from './common.js';

/**
 * Populates the scoring distribution chart
 */
export function populateScoringDistribution(distribution: ScoringDistribution): void {
 ...
 */
export function populateRecentRounds(rounds: Round[]): void {
